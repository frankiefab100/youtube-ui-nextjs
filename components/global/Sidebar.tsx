...
const Sidebar: React.FC = () => {
  return (
    <aside>
      <div className="bg-backgroundPrimary md:flex hidden flex-col max-w-[16%] h-full fixed overflow-hidden whitespace-nowrap scrollbar hover:overflow-y-scroll">
      ...
      {/* { Mobile Sidebar} */}
      <div className="bg-backgroundPrimary md:hidden flex flex-col max-w-16 h-full fixed overflow-hidden whitespace-nowrap">
        <div className="py-3 border-b border-backgroundAccent">
